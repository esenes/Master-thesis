...
The data analysis showed that the power was not always cut immediately. This could trigger a breakdown  following the original one, provoked by a malfunctioning of the instrumentation that did not cut the power. For this reason, all the events in the next three seconds after a breakdown are discarded. This is a common procedure carried out also in the other XBOX stands at CERN, and constitutes an issue that will be investigated in the future. 
