...
The importance of accelerators occupies a key role nowadays, not only to progress in the understanding of particle physics, but also inquiring every phenomenon at the nano-scale requires the use of accelerators. In this perspective accelerators for physical research represent the cutting-edge technology available, and the development of new projects guarantee the technology for all the other applications in few years. 
...
The probability of observe a particular interaction process is given by
\[
P = \mathscr{L} \sigma
\]
...
\begin{table}
  \centering
    ...
    \hline
    Parameter								& LEP2	&	FCC-ee	& CLIC	& CLIC	&	ILC	\\
    \hline
