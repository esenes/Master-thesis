...
The used repetition rate is 25 or 50 Hz, to accumulate higher statistics.

After a breakdown, the power is stopped as foreseen in the CLIC scenario. After 3 s of stop, the power is gradually ramped up. Overall, the power restoration last less than 10 s if another breakdown does not happens.
